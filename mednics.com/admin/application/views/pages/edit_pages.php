                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption font-orange">
                                            ...
                                            <span class="caption-subject bold uppercase">Edit Pages</span>
                                        </div>
                                    </div>
                                    <div class="portlet-body form">
                                    <?php $epages_id = $this->crm_auth->encrypt_openssl($pages_id); ?>
                                       <form class=" form-manager" enctype="multipart/form-data" role="form" id="edit-form" name="edit-form" method="post" action="<?php echo site_url('edit-pages-'.$epages_id);?>">
                                            <div class="form-body">
                                                
                                                <input type="hidden" id="id" name="id" value="<?php echo $pages['id']?>">
                                                <div class="row">                                                          
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="form_control_1">Name</label>
                                                            <input type="text" class="form-control" name="name" id="name" value="<?php echo $pages['name'];?>">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" name="description" id="description"><?php echo $pages['description'];?></textarea>
                                                 ...
                                                 <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="page_url" id="page_url" value="<?php echo $pages['page_url'];?>">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="page_title" id="page_title" value="<?php echo $pages['page_title'];?>">
                                                ...
                                                <div class="row">                                                          
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="meta_title" id="meta_title" value="<?php echo $pages['meta_title'];?>">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="meta_keyword" id="meta_keyword" value="<?php echo $pages['meta_keyword'];?>">
                                                ...
                                                <div class="row">                                                          
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" name="meta_description" id="meta_description"><?php echo $pages['meta_description'];?></textarea>
