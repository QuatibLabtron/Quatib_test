...
<html lang="en">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
                            ...
                            <div class="col-md-12 ">
                                <div class="portlet light bordered">
                                    ...
                                    <div class="portlet-title">
                                        <span class="caption-subject bold uppercase font-orange">Pages list 
                                       
                                    <a href="<?php echo site_url('add-pages')?>" class="btn btn green"><i class="fa fa-plus"></i> Add Pages</a> </span>

                                         <a class="btn btn green" onclick="return ConverToActive()"><i class="fa fa-check"></i> Active</a> </span>

                                          <a class="btn btn green" onclick="return ConverToDeactive()"><i class="fa fa-close"></i> Deactive</a> </span>

                                           <a  href="<?php echo SAMPLE_EXCEL_PATH.'ExportPages.xls';  ?>" class="btn btn green" download><i class="fa fa-download"></i> Sample Excel</a>

                                            <a class="btn btn green" href="<?php echo base_url('pages-export') ?>"><i class="fa fa-file-excel-o"></i> Export</a>

                                             <a class="btn btn green" href="<?php echo base_url('pages-import') ?>"><i class="fa fa-upload"></i> Import</a>
                                    ...
                                    <div class="portlet-body">
                                        <form method="post" enctype="multipart/form-data" id="frmListing">
                                            <table class="table table-striped table-bordered table-hover pages-list" id="sample_1">
                                                <thead>
                                                    <tr>
                                                        <th> </th>
                                                        <th> Name</th>
        ...
        $(document).ready(function(){
            ...
            {
                var customDataTableElement = '.pages-list';
                $(customDataTableElement).DataTable().destroy();
                var customDataTableCount   = '<?php echo $dataTableData->table_data_count; ?>';
                var customDataTableServer  = <?php echo $dataTableData->table_server_status; ?>;
                var customDataTableUrl     =  baseUrl + 'getpageslist?table_data_count='+customDataTableCount;
                var customDataTableColumns = [
                   ...
                   {   'data'  : 'name' ,
                    ...
                    {
                        link = `
                               <a href="`+baseUrl+`pages-detail-`+row.id_encrypt+`" title=" Detail View "> `+row.name+`</a>
                              `;
