                               ...
                               <div class="portlet light bordered">
                                  <div class="portlet-title">
                                     <div class="caption font-orange">
                                        ...
                                        <span class="caption-subject bold uppercase">Add Pages</span>
                                     </div>
                                  </div>
                                  <div class="portlet-body form">
                                     <form class="form-manager" enctype="multipart/form-data" role="form" id="add-form" name="add-form" method="post" action="<?php echo site_url('add-pages');?>">
                                        <div class="form-body">
                                           <div class="row">
                                              <div class="col-md-6">
