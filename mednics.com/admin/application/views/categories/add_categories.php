                               ...
                               <div class="portlet light bordered">
                                  <div class="portlet-title">
                                     <div class="caption font-orange">
                                        ...
                                        <span class="caption-subject bold uppercase">Add Categories</span>
                                     </div>
                                  </div>
                                  <div class="portlet-body form">
                                     <form class="form-manager" enctype="multipart/form-data" role="form" id="add-form" name="add-form" method="post" action="<?php echo site_url('add-categories');?>">
                                        <div class="form-body">
                                           <div class="row">
                                              <div class="col-md-6">
                                           ...
                                           <div class="row">
                                              <div class="col-md-6">
                                                 <div class="form-group">
                                                    ...
                                                    <select  class="form-control select2"   required id="section" name="section">
                                                       ...
                                                       <?php echo getCombo("SELECT section as f2,page_url as f1 FROM sections where status=".STATUS_ACTIVE." " );?>
                                                    </select>
                                              ...
                                              <div class="col-md-6">
                                                 <div class="form-group">
                                                    ...
                                                    <input type="text"  class="form-control" name="url_title" id="url_title" value="<?php echo set_value('url_title');?>">
                                           ...
                                           <div class="row">
                                              <div class="col-md-6">
                                                 <div class="form-group">
                                                    ...
                                                    <select  class="form-control select2" id="parent_id" name="parent_id" onchange=" return get_category_level(this.value)">
                                                       <option value=0>Select Parent Category</option>
                                                       <?php echo getCombo("SELECT name as f2,id as f1 FROM categories where status=".STATUS_ACTIVE." " );?>
                                                    </select>
                                              ...
                                              <div class="col-md-6">
                                                 <div class="form-group">
                                                    ...
                                                    <input type="number" min=0 class="form-control" name="level" id="level" value="<?php echo set_value('level');?>">
