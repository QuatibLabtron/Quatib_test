                            ...
                            <div class="col-md-12 ">
                                <div class="portlet light bordered">
                                    ...
                                    <div class="portlet-title">
                                        <span class="caption-subject bold uppercase font-orange">Categories list </span>
                                       
                          <a href="<?php echo site_url('add-categories')?>" class="btn btn green"><i class="fa fa-plus"></i> Add Categories</a> 
                                         ...
                                         <a class="btn btn green" onclick="return ConverToActive()"><i class="fa fa-check"></i> Active</a>
                                          ...
                                          <a class="btn btn green" onclick="return ConverToDeactive()"><i class="fa fa-close"></i> Deactive</a>
                                           ...
                                           <a  href="<?php echo SAMPLE_EXCEL_PATH.'ExportCategories.xls';  ?>" class="btn btn green" download><i class="fa fa-download"></i> Sample Excel</a>

                                            <a class="btn btn green" href="<?php echo base_url('categories-export') ?>"><i class="fa fa-file-excel-o"></i> Export</a>

                                             <a class="btn btn green" href="<?php echo base_url('categories-import') ?>"><i class="fa fa-upload"></i> Import</a>
                                    ...
                                    <div class="portlet-body">
                                        <form method="post" enctype="multipart/form-data" id="frmListing">
                                            <table class="table table-striped table-bordered table-hover categories-list" id="sample_1">
                                                <thead>
                                                    <tr>
                                                        <th> </th>
