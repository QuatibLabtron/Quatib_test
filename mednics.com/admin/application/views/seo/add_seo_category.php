      ...
      <html lang="en">
         ...
         <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
                            ...
                            <div class="col-md-12 ">
                               ...
                               <div class="portlet light bordered">
                                  ...
                                  <div class="portlet-body form">
                                     <form class="form-manager" enctype="multipart/form-data" role="form" id="add-form" name="add-form" method="post" action="<?php echo site_url('add-seo-categorie');?>">
                                        <div class="form-body">
                                           <div class="row">
                                           ...
                                           <div class="row">
                                              <div class="col-md-12">
                                                 <div class="form-group">
                                                    <label for="form_control_1">Categories List</label>
													  <select id="categoryid" name="categoryid" class="form-control organisation-select2 select2" onchange="getseolist(this.value);">
                                                                       <option value=''>Select Organisation</option>
                                                                           <?php echo getCombo("SELECT name as f2,id as f1 FROM categories where status=".STATUS_ACTIVE." ORDER BY name ASC ",!empty($categories['id'])?$categories['id']:""  );?>  
                                                                    </select>
											  ...
											  <div class="col-md-12">
                                                 <div class="form-group">
                                                    <label for="form_control_1">Meta Title</label>
          ...
          if (url) { // require a URL
              window.location = "add-seo-categorie-"+url; // redirect
          }
          return false;
