...
<html lang="en">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
                            ...
                            <div class="col-md-12 ">
                                <div class="portlet light bordered">
                                    ...
                                    <div class="portlet-title">
                                        <span class="caption-subject bold uppercase font-orange">Section list </span>
                                       
                                   <a href="<?php echo site_url('add-section')?>" class="btn btn green"><i class="fa fa-plus"></i> Add Section</a> 
                                         ...
                                         <a class="btn btn green" onclick="return ConverToActive()"><i class="fa fa-check"></i> Active</a>
                                          ...
                                          <a class="btn btn green" onclick="return ConverToDeactive()"><i class="fa fa-close"></i> Deactive</a>
                                           ...
                                           <a  href="<?php echo SAMPLE_EXCEL_PATH.'ExportSections.xls';  ?>" class="btn btn green" download><i class="fa fa-download"></i> Sample Excel</a>

                                            <a class="btn btn green" href="<?php echo base_url('section-export') ?>"><i class="fa fa-file-excel-o"></i> Export</a>

                                             <a class="btn btn green" href="<?php echo base_url('section-import') ?>"><i class="fa fa-upload"></i> Import</a>
                                    ...
                                    <div class="portlet-body">
                                        <form method="post" enctype="multipart/form-data" id="frmListing">
                                            <table class="table table-striped table-bordered table-hover section-list" id="sample_1">
                                                <thead>
                                                    <tr>
                                                        <th> </th>
                                                        <th> Section Name</th>
        ...
        $(document).ready(function(){
            ...
            {
                var customDataTableElement = '.section-list';
                $(customDataTableElement).DataTable().destroy();
                var customDataTableCount   = '<?php echo $dataTableData->table_data_count; ?>';
                var customDataTableServer  = <?php echo $dataTableData->table_server_status; ?>;
                var customDataTableUrl     =  baseUrl + 'getsectionlist?table_data_count='+customDataTableCount;
                var customDataTableColumns = [
                   ...
                   {   'data'  : 'section' ,
                    ...
                    {
                        link = `
                               <a href="`+baseUrl+`section-detail-`+row.id_encrypt+`" title=" Detail View "> `+row.section+`</a>
                              `;
             ...
             function ConverToDeactive()
            {
                ...
                var dataString = $('#frmListing').serialize();
                  ...
                  {
                    type: "POST",
                    url: baseUrl + "section-deactivate",
                    data : dataString,
                    success: function(response)
                    {
                      response = JSON.parse(response);
