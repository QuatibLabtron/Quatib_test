                            ...
                            <div class="col-md-12 ">
                                <div class="portlet light bordered">
                                     <div class="portlet-title">
                                        <span class="caption-subject bold uppercase font-orange">User list 
                                       
                                        <a href="<?php echo site_url('add-user')?>" class="btn btn green"><i class="fa fa-plus"></i> Add User</a> </span>
            ...
            function getUserlist()
            {
                ...
                var customDataTableColumns = [
                   ...
                   {   'data'  : 'prs_name' ,
                    ...
                    {
                        link = `
                               <a href="`+baseUrl+`user-details-`+row.prs_username+`" title=" Detail View "> `+row.prs_name+`</a>
                              `;
