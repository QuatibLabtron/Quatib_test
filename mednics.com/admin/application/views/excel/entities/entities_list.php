...
<html lang="en">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
                            ...
                            <div class="col-md-12 ">
                                <div class="portlet light bordered">
                                    ...
                                    <div class="portlet-title">
                                        <span class="caption-subject bold uppercase font-orange">Entities list 
                                       
                                        <a href="<?php echo site_url('add-entities')?>" class="btn btn green"><i class="fa fa-plus"></i> Add Entities</a> </span>
                                    ...
                                    <div class="portlet-body">
                                        <form method="post" enctype="multipart/form-data" id="frmListing">
                                            <table class="table table-striped table-bordered table-hover entities-list" id="sample_1">
                                                <thead>
                                                    <tr>
                                                        <th> </th>
                                                        <th> Name</th>
        ...
        $(document).ready(function(){
            ...
            {
                var customDataTableElement = '.entities-list';
                $(customDataTableElement).DataTable().destroy();
                var customDataTableCount   = '<?php echo $dataTableData->table_data_count; ?>';
                var customDataTableServer  = <?php echo $dataTableData->table_server_status; ?>;
                var customDataTableUrl     =  baseUrl + 'getentitieslist?table_data_count='+customDataTableCount;
                var customDataTableColumns = [
                   ...
                   {   'data'  : 'name' ,
                    ...
                    {
                        link = `
                               <a href="`+baseUrl+`entities-detail-`+row.id_encrypt+`" title=" Detail View "> `+row.name+`</a>
                              `;
             ...
             function ConverToDeactive()
            {
                ...
                var dataString = $('#frmListing').serialize();
                  ...
                  {
                    type: "POST",
                    url: baseUrl + "entities-deactivate",
                    data : dataString,
                    success: function(response)
                    {
                      response = JSON.parse(response);
