...
<html lang="en">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
                            ...
                            <div class="col-md-12 ">
                                <div class="portlet light bordered">
                                    ...
                                    <div class="portlet-title">
                                        <span class="caption-subject bold uppercase font-orange">Data types list 
                                       
                                        <a href="<?php echo site_url('add-datatypes')?>" class="btn btn green"><i class="fa fa-plus"></i> Add Data types</a> </span>
                                    ...
                                    <div class="portlet-body">
                                        <form method="post" enctype="multipart/form-data" id="frmListing">
                                            <table class="table table-striped table-bordered table-hover datatypes-list" id="sample_1">
                                                <thead>
                                                    <tr>
                                                        <th> </th>
                                                        <th> Name</th>
                                                        <th> Table column type</th>
                                                        <th> Type</th>
                                                        <th> Created By </th>  
                                                        <th> Updated By </th>    
                                                        <th> Status </th>    
        ...
        $(document).ready(function(){
            ...
            {
                var customDataTableElement = '.datatypes-list';
                $(customDataTableElement).DataTable().destroy();
                var customDataTableCount   = '<?php echo $dataTableData->table_data_count; ?>';
                var customDataTableServer  = <?php echo $dataTableData->table_server_status; ?>;
                var customDataTableUrl     =  baseUrl + 'getdatatypeslist?table_data_count='+customDataTableCount;
                var customDataTableColumns = [
                   ...
                   {   'data'  : 'name' ,
                    ...
                    {
                        link = `
                               <a href="`+baseUrl+`datatypes-detail-`+row.id_encrypt+`" title=" Detail View "> `+row.name+`</a>
                              `;
                      
                      return link;
                    }
                  },
                  {   'data'  : 'table_column_type' },
                  {   'data'  : 'type' },
                  {   'data'  : 'createdby' },
                  {   'data'  : 'updatedby' },
                  {   'data'  : 'status_name' }
            ...
            function ConverToActive()
            {
                ...
                var dataString = $('#frmListing').serialize();
                  ...
                  {
                    type: "POST",
                    url: baseUrl + "datatypes-activate",
                    data : dataString,
             ...
             function ConverToDeactive()
            {
                ...
                var dataString = $('#frmListing').serialize();
                  ...
                  {
                    type: "POST",
                    url: baseUrl + "datatypes-deactivate",
                    data : dataString,
                    success: function(response)
                    {
                      response = JSON.parse(response);
