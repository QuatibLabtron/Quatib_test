...
<style>
    ...
    <body class=" login">
        ...
        <!-- END LOGIN -->
        <!-- BEGIN COPYRIGHT -->
        <div class="copyright" style="text-align: center;">  &copy; 2023. All rights reserved. Design by:   <a href="https://www.sazmed.com/" target="_blank"><span class="white_font">Sazmed Ltd.</span></a> </div>
