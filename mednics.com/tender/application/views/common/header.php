<style type="text/css">
label.error {color: #ff6161 !important;font-size: 12px;sfont-weight: 500;}
.page-header.navbar .top-menu .navbar-nav>li.dropdown-user .dropdown-toggle { margin-top: 20px;padding: 6px 6px 6px 8px;}
.pagination>.active>a, .pagination>.active>a:focus, .pagination>.active>a:hover, .pagination>.active>span, .pagination>.active>span:focus, .pagination>.active>span:hover { background-color: #333;border-color: #f6f5f9;}
	...
	<div class="page-header-inner ">
		...
		<div class="page-logo">
			<a href="<?php echo site_url('dashboard')?>">
				...
				?>
				<!-- <img src="<?php echo $image_path; ?>" alt="logo" class="logo-default" /> </a> -->
			...
			<ul class="nav navbar-nav pull-right">
				<li class="dropdown dropdown-user">
					<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
						<?php /*<img alt="" class="img-circle" src="<?php echo base_url()?>assets/layouts/layout/img/avatar3_small.jpg" />*/ ?>
