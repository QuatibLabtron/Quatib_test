    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
                            ...
                            <div class="col-md-12 ">
                                <div class="portlet light bordered">
                                    ...
                                    <div class="portlet-title">
                                        ...
                                        <a href="<?php echo site_url('add-contacts')?>" class="btn btn green"><i class="fa fa-plus"></i> Add </a> 
                                        ...
                                        <?php   /*<a  href="<?php echo SAMPLE_EXCEL_PATH.'contacts.xls';  ?>" class="btn btn green" download><i class="fa fa-download"></i> Sample Excel</a>

                                            <a class="btn btn green" href="<?php echo base_url('contacts-export') ?>"><i class="fa fa-file-excel-o"></i> Export</a>

                                             <a class="btn btn green" href="<?php echo base_url('contacts-import') ?>"><i class="fa fa-upload"></i> Import</a>*/ ?>
        ...
        $(document).ready(function(){
            ...
            function getcontactslist()
            {
                ...
                var customDataTableUrl     =  baseUrl + 'getcontactslist?table_data_count='+customDataTableCount;
                var customDataTableColumns = [
                   ...
                   {   'data'  : 'cont_name' ,
                    ...
                    {
                        link = `
                               <a href="`+baseUrl+`contacts-detail-`+row.id_encrypt+`" title=" Detail View "> `+row.cont_name+`</a>
                              `;
             ...
             function ConverToDeactive()
            {
                ...
                var dataString = $('#frmListing').serialize();
                  ...
                  {
                    type: "POST",
                    url: baseUrl + "contacts-deactivate",
                    data : dataString,
                    success: function(response)
                    {
                      response = JSON.parse(response);
