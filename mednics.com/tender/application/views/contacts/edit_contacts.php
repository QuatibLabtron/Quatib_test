                                ...
                                <div class="portlet light bordered">
                                    ...
                                    <div class="portlet-title">
                                        ...
                                        <div class="caption font-orange">
                                            ...
                                            <span class="caption-subject bold uppercase">Edit Contacts</span>
                                    ...
                                    <?php $econtacts_id = $this->crm_auth->encrypt_openssl($contacts_id); ?>

                                       <form class=" form-manager" enctype="multipart/form-data" role="form" id="edit-form" name="edit-form" method="post" action="<?php echo site_url('edit-contacts-'.$econtacts_id);?>">

                                            <div class="form-body">

                                                

                                                <input type="hidden" id="cont_id" name="cont_id" value="<?php echo $contacts['cont_id']?>">
                                                 ...
                                                 <div class="portlet light bordered">
                                                  ...
                                                  <div class="Portlet-body">
                                                          ...
                                                          <div class="col-md-6">
                                                              ...
                                                              <div class="form-group">
                                                                  ...
                                                                  <select name="cont_type" id="cont_type" class="form-control select2">
                                                                      ...
                                                                      <?php echo getCombo('select gen_value as f1 ,gen_name as f2 from tender_gen_prm where status= "'.STATUS_ACTIVE.'" and gen_group = "'.TENDER_CONTACT_TYPE.'" ',$contacts['cont_type'])?>
                                                      ...
                                                      <div class="row">
                                                                  ...
                                                                  <div class="input-group select2-bootstrap-append">
                                                                      ...
                                                                      <div class="input-group-btn select_width">
                                                                          ...
                                                                          <select id="cont_sal" name="cont_sal" class="form-control select2">
                                                                              ...
                                                                              <?php echo getCombo('select gen_value as f1 ,gen_name as f2 from tender_gen_prm where status= "'.STATUS_ACTIVE.'" and +gen_group = "'.TENDER_SALUTION.'" ',$contacts['cont_sal'])?>
                                                                      ...
                                                                      <input type="text" class="form-control text-file" name="cont_firstname" id="cont_firstname" value="<?php echo $contacts['cont_firstname']?>">
                                                          ...
                                                          <div class="col-md-6">
                                                              ...
                                                              <div class="form-group">
                                                                  ...
                                                                  <input type="text" class="form-control" name="cont_lastname" id="cont_lastname" value="<?php echo $contacts['cont_lastname']?>">
                                                      ...
                                                      <div class="row">
                                                          ...
                                                          <div class="col-md-6">
                                                              ...
                                                              <div class="form-group">
                                                                  ...
                                                                  <input type="text" class="form-control" name="cont_primaryemail" id="cont_primaryemail" value="<?php echo $contacts['cont_primaryemail']?>">
                                                          ...
                                                          <div class="col-md-6">
                                                              ...
                                                              <div class="form-group">
                                                                  ...
                                                                  <input type="text" class="form-control" name="cont_secondaryemail" id="cont_secondaryemail" value="<?php echo $contacts['cont_secondaryemail']?>">
                                                      ...
                                                      <div class="row">
                                                          ...
                                                          <div class="col-md-6">
                                                              ...
                                                              <div class="form-group">
                                                                  ...
                                                                  <input type="text" class="form-control" name="cont_mobilephone" id="cont_mobilephone" value="<?php echo $contacts['cont_mobilephone']?>">
                                                          ...
                                                          <div class="col-md-6">
                                                              ...
                                                              <div class="form-group">
                                                                  ...
                                                                  <input type="text" class="form-control" name="cont_altphone" id="cont_altphone" value="<?php echo $contacts['cont_altphone']?>">
                                                      ...
                                                      <div class="row">
                                                          ...
                                                          <div class="col-md-6">
                                                              ...
                                                              <div class="form-group">
                                                                  ...
                                                                  <input type="text" class="form-control" name="cont_department" id="cont_department" value="<?php echo $contacts['cont_department']?>">
                                                          ...
                                                          <div class="col-md-6">
                                                              ...
                                                              <div class="form-group">
                                                                  ...
                                                                  <select name="cont_leadsource" id="cont_leadsource" class="form-control select2">
                                                                      ...
                                                                      <?php echo getCombo('select gen_value as f1 ,gen_name as f2 from tender_gen_prm where status= "'.STATUS_ACTIVE.'" and gen_group = "'.TENDER_LEAD_SOURCE.'" ',$contacts['cont_leadsource'])?>
                                                      ...
                                                      <input type="hidden" name="cont_assignedid" id="cont_assignedid" value="<?php echo $contacts['cont_assignedid'] ?>">
                                                      <input type="hidden" name="cont_assignedto" id="cont_assignedto" value="<?php echo $contacts['cont_assignedto'] ?>">
                                                      ...
                                                      <div class="row">
                                                          ...
                                                          <div class="col-md-6">
                                                              ...
                                                              <div class="form-group">
                                                                  ...
                                                                  <select name="cont_assignedto1" id="cont_assignedto1" class="form-control" readonly>

                                                                      <!--  <option value=''>Select Currency</option> -->

                                                                      <?php echo getCombo('select prs_username as f1 ,prs_name as f2 from tender_person where status= "'.STATUS_ACTIVE.'"  ',$contacts['cont_assignedto'])?>
                                                          ...
                                                          <div class="col-md-6">
                                                              ...
                                                              <div class="form-group">
                                                                  ...
                                                                  <select name="cont_orgid" id="cont_orgid" class="form-control select2">
                                                                       ...
                                                                       <?php echo getCombo('select org_id as f1 ,org_name as f2 from tender_organisation where status= "'.STATUS_ACTIVE.'" ',$contacts['cont_orgid'])?>
                                                      ...
                                                      <div class="row">
                                                          ...
                                                          <div class="col-md-6">
                                                              ...
                                                              <div class="form-group">
                                                                  ...
                                                                  <textarea class="form-control" name="cont_desc" id="cont_desc" data-msg="PLease enter Description"><?php echo $contacts['cont_desc'] ?></textarea>
                                                          ...
                                                          <div class="col-md-6">
                                                              ...
                                                              <div class="form-group">
                                                                  ...
                                                                  <textarea class="form-control" name="cont_comment" id="cont_comment" data-msg="Please enter Comment"><?php echo $contacts['cont_comment'] ?></textarea>
