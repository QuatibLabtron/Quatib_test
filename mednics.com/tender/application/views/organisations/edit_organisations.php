                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption font-orange">
                                            ...
                                            <span class="caption-subject bold uppercase">Edit Organisations</span>
                                        </div>
                                    </div>
                                    <div class="portlet-body form">
                                    <?php $eorganisations_id = $this->crm_auth->encrypt_openssl($organisations_id); ?>
                                       <form class=" form-manager" enctype="multipart/form-data" role="form" id="edit-form" name="edit-form" method="post" action="<?php echo site_url('edit-organisations-'.$eorganisations_id);?>">
                                            <div class="form-body">
                                                
                                                <input type="hidden" id="org_id" name="org_id" value="<?php echo $organisations['org_id']?>">
                                                 <div class="portlet light bordered">
                                                       ...
                                                       <div class="row">
                                                          <div class="col-md-6">
                                                             <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="org_name" id="org_name" value="<?php echo $organisations['org_name']?>">
                                                          ...
                                                          <div class="col-md-6">
                                                             <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="org_primaryemail" id="org_primaryemail" value="<?php echo $organisations['org_primaryemail']?>">
                                                       ...
                                                       <div class="row">
                                                          <div class="col-md-6">
                                                             <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="org_secondaryemail" id="org_secondaryemail" value="<?php echo $organisations['org_secondaryemail']?>">
                                                          ...
                                                          <div class="col-md-6">
                                                             <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="org_tertiaryemail" id="org_tertiaryemail" value="<?php echo $organisations['org_tertiaryemail']?>">
                                                       ...
                                                       <div class="row">
                                                          <div class="col-md-6">
                                                             <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="org_primaryphone" id="org_primaryphone" value="<?php echo $organisations['org_primaryphone']?>">
                                                          ...
                                                          <div class="col-md-6">
                                                             <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="org_altphone" id="org_altphone" value="<?php echo $organisations['org_altphone']?>">
                                                        ...
                                                        <div class="row">
                                                          <div class="col-md-6">
                                                             <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="org_fax" id="org_fax" value="<?php echo $organisations['org_fax']?>">
                                                          ...
                                                          <div class="col-md-6">
                                                             <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="org_website" id="org_website" value="<?php echo $organisations['org_website']?>">
                                                                <span class="text-danger"><?php echo form_error('org_website');?></span>
                                                             </div>
                                                          </div>
                                                       </div>
                                                   
                                                    <input type="hidden" name="org_assignedid" id="org_assignedid" value="<?php echo $organisations['org_assignedid']?>">
                                                                ...
                                                                <label for="form_control_1">Assigned To</label>
                                                                  <select name="org_assignedto" id="org_assignedto" class="form-control" readonly>
                                                                     <!--  <option value=''>Select Currency</option> -->
                                                                        <?php echo getCombo('select prs_username as f1 ,prs_name as f2 from tender_person where status= "'.STATUS_ACTIVE.'" and prs_id = "'.$organisations['org_assignedid'].'" ')?> 
                                                                  </select>
                                                             ...
                                                             <div class="form-group">
                                                                ...
                                                                <select name="org_industry" id="org_industry" class="form-control select2">
                                                                      <option value=''>Select Industry</option>
                                                                        <?php echo getCombo('select gen_value as f1 ,gen_name as f2 from tender_gen_prm where status= "'.STATUS_ACTIVE.'" and gen_group = "'.TENDER_INDUSTRY.'" ',$organisations['org_industry'])?> 
                                                                  </select>
                                                                <span class="text-danger"><?php echo form_error('org_industry');?></span>
                                                             </div>
                                                          </div>
                                                       </div>
                                                       <div class="row">
                                                          <div class="col-md-6">
                                                             <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="org_cst" id="org_cst" value="<?php echo $organisations['org_cst']?>">
                                                          ...
                                                          <div class="col-md-6">
                                                             <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="org_vat" id="org_vat" value="<?php echo $organisations['org_vat']?>">
                                                        ...
                                                        <div class="row">
                                                          <div class="col-md-6">
                                                             <div class="form-group">
                                                                ...
                                                                <textarea class="form-control" name="org_billingadd" id="org_billingadd" data-msg="PLease enter Billing Address" ><?php echo $organisations['org_billingadd'] ?></textarea>
                                                          ...
                                                          <div class="col-md-6">
                                                             <div class="form-group">
                                                                ...
                                                                <textarea class="form-control" name="org_shippingadd" id="org_shippingadd" data-msg="PLease enter Shipping Address" ><?php echo $organisations['org_shippingadd'] ?></textarea>
                                                       ...
                                                       <div class="row">
                                                          <div class="col-md-6">
                                                             <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="org_billingpob" id="org_billingpob" value="<?php echo $organisations['org_billingpob']?>">
                                                          ...
                                                          <div class="col-md-6">
                                                             <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="org_shippingpob" id="org_shippingpob" value="<?php echo $organisations['org_shippingpob']?>">
                                                        ...
                                                        <div class="row">
                                                          <div class="col-md-6">
                                                             <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="org_billingcity" id="org_billingcity" value="<?php echo $organisations['org_billingcity']?>">
                                                          ...
                                                          <div class="col-md-6">
                                                             <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="org_shippingcity" id="org_shippingcity" value="<?php echo $organisations['org_shippingcity']?>">
                                                       ...
                                                       <div class="row">
                                                          <div class="col-md-6">
                                                             <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="org_billingstate" id="org_billingstate" value="<?php echo $organisations['org_billingstate']?>">
                                                          ...
                                                          <div class="col-md-6">
                                                             <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="org_shippingstate" id="org_shippingstate" value="<?php echo $organisations['org_shippingstate']?>">
                                                       ...
                                                       <div class="row">
                                                          <div class="col-md-6">
                                                             <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="org_billingpoc" id="org_billingpoc" value="<?php echo $organisations['org_billingpoc']?>">
                                                          ...
                                                          <div class="col-md-6">
                                                             <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="org_shippingpoc" id="org_shippingpoc" value="<?php echo $organisations['org_shippingpoc']?>">
                                                             ...
                                                             <div class="form-group">
                                                               ...
                                                               <select name="org_billingcountry" id="org_billingcountry" class="form-control select2">
                                                                   <option value=''>Select Country</option>
                                                                    <?php echo getCombo('select tcv_id as f1 ,tcv_country as f2 from tender_country_vol',$organisations['org_billingcountry'])?> 
                                                              </select>
                                                          ...
                                                          <div class="col-md-6">
                                                             <div class="form-group">
                                                                ...
                                                                <select name="org_shippingcountry" id="org_shippingcountry" class="form-control select2">
                                                                   <option value=''>Select Country</option>
                                                                    <?php echo getCombo('select tcv_id as f1 ,tcv_country as f2 from tender_country_vol',$organisations['org_shippingcountry'])?> 
                                                                  </select>
                                                        ...
                                                        <div class="row">
                                                          <div class="col-md-6">
                                                             <div class="form-group">
                                                                ...
                                                                <textarea class="form-control" name="org_desc" id="org_desc" data-msg="PLease enter Description" ><?php echo $organisations['org_desc'] ?></textarea>
                                                          ...
                                                          <div class="col-md-6">
                                                             <div class="form-group">
                                                                ...
                                                                <textarea class="form-control" name="org_comment" id="org_comment" data-msg="Please enter Comment" ><?php echo $organisations['org_comment'] ?></textarea>
