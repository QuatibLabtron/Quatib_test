    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
                            ...
                            <div class="col-md-12 ">
                                <div class="portlet light bordered">
                                    ...
                                    <div class="portlet-title">
                                        <span class="caption-subject bold uppercase font-orange">Organisation list </span>
                                       
                                        <a href="<?php echo site_url('add-organisations')?>" class="btn btn green"><i class="fa fa-plus"></i> Add </a> 
                                        ...
                                        <?php   /* <a  href="<?php echo SAMPLE_EXCEL_PATH.'organisations.xls';  ?>" class="btn btn green" download><i class="fa fa-download"></i> Sample Excel</a>
                                            <a class="btn btn green" href="<?php echo base_url('organisations-export') ?>"><i class="fa fa-file-excel-o"></i> Export</a>
                                             <a class="btn btn green" href="<?php echo base_url('organisations-import') ?>"><i class="fa fa-upload"></i> Import</a>*/ ?>
                                    ...
                                    <div class="portlet-body">
                                        <form method="post" enctype="multipart/form-data" id="frmListing">
                                            <table class="table table-striped table-bordered table-hover organisations-list" id="sample_1">
                                                <thead>
                                                    <tr>
                                                        <th> </th>
                                                        <th> Name</th>
      ...
      <?php $this->load->view('common/footer_style'); ?> 
        ...
        $(document).ready(function(){
            ...
            {
                var customDataTableElement = '.organisations-list';
                $(customDataTableElement).DataTable().destroy();
                var customDataTableCount   = '<?php echo $dataTableData->table_data_count; ?>';
                var customDataTableServer  = <?php echo $dataTableData->table_server_status; ?>;
                var customDataTableUrl     =  baseUrl + 'getorganisationslist?table_data_count='+customDataTableCount;
                var customDataTableColumns = [
                   ...
                   {   'data'  : 'org_name' ,
                    ...
                    {
                        link = `
                               <a href="`+baseUrl+`organisations-detail-`+row.id_encrypt+`" title=" Detail View "> `+row.org_name+`</a>
                              `;
            ...
            function ConverToActive()
            {
                ...
                var dataString = $('#frmListing').serialize();
                  ...
                  {
                    type: "POST",
                    url: baseUrl + "organisations-activate",
                    data : dataString,
             ...
             function ConverToDeactive()
            {
                ...
                var dataString = $('#frmListing').serialize();
                  ...
                  {
                    type: "POST",
                    url: baseUrl + "organisations-deactivate",
                    data : dataString,
                    success: function(response)
                    {
                      response = JSON.parse(response);
